'''
    File:        excercise3_Alter.py
    Description: Defines activities for Excercise 3 using an alternative form of
                 to define initial centroids for kmeans algorithm.
...
if __name__ == "__main__":
    ...
    for i in ranges:
        ...
        c, J, k = k_means_alter(list_of_pixels, i, prevclusters)

        # save prev clusters for later
        prevclusters = k
